...
public class TestR4_Risultati extends TestCase {
  ...
  protected void setUp() throws Exception {
    super.setUp();
		...
		Iterator<Cittadino> it=elezione.getElettori().iterator();
	...
	public void testListe(){
		...
		Collection<Lista> liste = elezione.getRisultatiListe();
	...
	public void testCandidati(){
		Collection<Cittadino> candidati = elezione.getRisultatiCandidati();
