...
public class TestR5_Criticita extends TestCase{
    ...
    public void setUp(){
         ...
         try {
            ...
            lu.addAereo("543", 100);
            lu.addAereo("652", 120);
            lu.addVolo("LH359", "543", "Paris", "Torino", "Gioved�");
            lu.addVolo("LH274", "652", "Paris", "London", "Venerd�");
            lu.addVolo("LH567", "734", "Torino", "London", "Venerd�");
            lu.addVolo("LH358", "734", "Torino", "Paris", "Marted�");
        } catch (InvalidCode e) {
	...
	public void testVoliCritici() {
		try {
			assertTrue(lu.prenota(20, "LH358")); //critico
			assertTrue(lu.prenota(80, "LH359")); 
			assertTrue(lu.prenota(10, "LH567")); //critico
